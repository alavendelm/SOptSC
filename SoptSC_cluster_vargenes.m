function [W,No_cluster,cluster_label,H,eigenvalues] = SoptSC_cluster_vargenes(data,NC,No_exc_cell,vargeneind,folder)
% G_filter_idx
...
%% Alternative gene selection
[No_genes,No_cells] = size(data);

input_data = data(vargeneind,:);
